...
class LrsLoadBalancingConfig {
    constructor(clusterName, edsServiceName, lrsLoadReportingServer, locality, childPolicy) {
    ...
    static createFromJson(obj) {
        ...
        return new LrsLoadBalancingConfig(obj.cluster_name, obj.eds_service_name, xds_bootstrap_1.validateXdsServerConfig(obj.lrs_load_reporting_server), {
    ...
    pick(pickArgs) {
        ...
        if (wrappedPick.pickResultType === PickResultType.COMPLETE) {
            return {
                ...
                onCallEnded: status => {
                    var _a;
                    (_a = wrappedPick.onCallEnded) === null || _a === void 0 ? void 0 : _a.call(wrappedPick, status);
                    this.localityStatsReporter.addCallFinished(status !== grpc_js_1.status.OK);
                }
            };
        }
        else {
...
class LrsLoadBalancer {
    ...
    updateAddressList(addressList, lbConfig, attributes) {
        ...
        this.localityStatsReporter = attributes.xdsClient.addClusterLocalityStats(lbConfig.getLrsLoadReportingServer(), lbConfig.getClusterName(), lbConfig.getEdsServiceName(), lbConfig.getLocality());
