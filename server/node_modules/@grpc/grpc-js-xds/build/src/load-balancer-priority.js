...
exports.setup = exports.PriorityLoadBalancer = exports.isLocalityEndpoint = void 0;
...
;
function isLocalityEndpoint(address) {
    return Array.isArray(address.localityPath);
}
exports.isLocalityEndpoint = isLocalityEndpoint;
    ...
    updateAddressList(endpointList, lbConfig, attributes) {
        ...
        for (const [childName, childConfig] of lbConfig.getChildren()) {
            ...
            if (existingChild !== undefined) {
                existingChild.updateAddressList(childAddresses, childConfig.config, attributes);
            }
        }
