...
export declare class LrsLoadBalancingConfig implements LoadBalancingConfig {
    ...
    toJsonObject(): object;
    constructor(clusterName: string, edsServiceName: string, lrsLoadReportingServer: XdsServerConfig, locality: Locality__Output, childPolicy: LoadBalancingConfig[]);
    getClusterName(): string;
    getEdsServiceName(): string;
    getLrsLoadReportingServer(): XdsServerConfig;
