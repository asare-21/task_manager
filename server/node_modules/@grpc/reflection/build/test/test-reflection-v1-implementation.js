...
const reflection_v1_1 = require("../src/implementations/reflection-v1");
describe('GrpcReflectionService', () => {
    ...
    beforeEach(async () => {
        ...
        reflectionService = new reflection_v1_1.ReflectionV1Implementation(root);
    });
    describe('listServices()', () => {
        ...
        it('whitelists services properly', () => {
            ...
            reflectionService = new reflection_v1_1.ReflectionV1Implementation(root, { services: ['sample.SampleService'] });
            const { service: services } = reflectionService.listServices('*');
    ...
    describe('fileByFilename()', () => {
        it('finds files with transitive dependencies', () => {
            const descriptors = reflectionService
                ...
                .fileDescriptorProto.map(f => descriptor_1.FileDescriptorProto.decode(f));
            const names = descriptors.map((desc) => desc.name);
            assert.deepEqual(new Set(names), new Set(['sample.proto', 'vendor.proto', 'vendor_dependency.proto']));
        });
        ...
        it('errors with no file found', () => {
            assert.throws(() => reflectionService.fileByFilename('nonexistent.proto'), 'Proto file not found');
        });
    });
    describe('fileContainingSymbol()', () => {
        ...
        it('errors with no symbol found', () => {
            assert.throws(() => reflectionService.fileContainingSymbol('non.existant.symbol'), 'Symbol not found:');
        });
    ...
    describe('fileContainingExtension()', () => {
        ...
        it('errors with no symbol found', () => {
            assert.throws(() => reflectionService.fileContainingExtension('non.existant.symbol', 0), 'Extension not found');
        });
    });
    describe('allExtensionNumbersOfType()', () => {
        ...
        it('errors with no symbol found', () => {
            assert.throws(() => reflectionService.allExtensionNumbersOfType('non.existant.symbol'), 'Extensions not found');
        });
    });
});
//# sourceMappingURL=test-reflection-v1-implementation.js.map